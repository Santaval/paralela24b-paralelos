...
def generar_datos_particulas(n, archivo_salida="particulas.tsv"):
    ...
    with open(archivo_salida, "w") as archivo:
        ...
        for _ in range(n):
            masa = random.randint(1, 10000)  # Masa entre 1 y 10000
            radio = random.randint(1, 50)   # Radio entre 1 y 50
            x, y, z = (random.uniform(-1000, 1000) for _ in range(3))  # Posición entre -1000 y 1000
            vx, vy, vz = (random.uniform(-100, 100) for _ in range(3))  # Velocidad entre -100 y 100
