...
void HttpGolbachPendingRequest::sendResponse() {
    ...
    for (size_t i = 0; i < numbers.size(); i++) {
        ...
        // Verificar si el vector está vacío o si el primer elemento
        // indica un número inválido
